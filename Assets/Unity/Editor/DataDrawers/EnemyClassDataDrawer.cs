...
{
    public class EnemyClassDataDrawer : IDataDrawer<EnemyClass>
    {
        ...
        public void DrawGUI(EnemyClass value, IContext context, Action<EnemyClass> lateRef)
        {
